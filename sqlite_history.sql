# cats
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("むぅ", "2015-03-09", "♀", "0001.jpg", 1, 1);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("ジュジュ", "2015-04-26", "♀", "0002.jpg", 2, 1);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("桜", "2016-03-10", "♀", "0003.jpg", 3, 1);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("金太郎", "2017-10-20", "♂", "0004.jpg", 4, 2);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("ラン", "2017-10-24", "♀", "0005.jpg", 5, 2);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("ハンサム", "2017-04-03", "♂", "0006.jpg", 6, 3);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("みらい", "2017-05-28", "♀", "0007.jpg", 7, 3);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("もみじ", "2017-05-21", "♀", "0008.jpg", 3, 5);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("オレオ", "2017-07-31", "♂", "0009.jpg", 3, 5);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("ぼたん", "2018-03-17", "♂", "0010.jpg", 8, 5);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("もずく", "2016-02-17", "♀", "0011.jpg", 9, 6);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("正宗", "2018-01-20", "♂", "0012.jpg", 10, 1);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("もんじゃ", "2015-12-10", "♀", "0013.jpg", 10, 1);
insert into cats(name, birth_date, gender, image, breed_id, cafe_id) values("シッポコ", "2017-09-27", "♂", "0014.jpg", 10, 2);
...
# cafes
insert into cafes(name, address, homepage, a_hour_price, prefucture) values ("猫カフェMOCHA　池袋西口店", "東京都豊島区西池袋1-15-6-3F", "http://catmocha.jp/ikebukuro/", 1200, "tokyo");
insert into cafes(name, address, homepage, a_hour_price, prefucture) values ("猫カフェMOCHA　京都河原町店", "京都府京都市中京区河原町通三条下ル大黒町58　mina　4F", "http://catmocha.jp/kawaramachi/", 1200, "kyoto");
insert into cafes(name, address, homepage, a_hour_price, prefucture) values ("猫カフェMOCHA　名古屋栄店", "愛知県名古屋市中区栄3-32-6　BECOME　SAKAE　2F", "http://catmocha.jp/nagoya/", 1200, "aiti");
insert into cafes(name, address, homepage, a_hour_price, prefucture) values ("猫カフェ　モカラウンジ横浜店", "神奈川県横浜市西区南幸2-8-9 ブライト横浜ビル6階", "http://catmocha.jp/yokohama/", 1200, "kanagawa");
...
# breeds
insert into breeds(name) values ("メインクーン");
insert into breeds(name) values ("バーマン");
insert into breeds(name) values ("スコティッシュフォールド");
insert into breeds(name) values ("キンカロー");
insert into breeds(name) values ("サイベリアン");
insert into breeds(name) values ("スコティッシュ");
